...
$sArticle	.= "<fieldset class='padding-H-20'>
				...
				<fieldset class='padding-H-20'>
					...
					<p id='hidden-PlanningPDF' class='code padding-20 hidden'>
						...
						<span class='variable'>\$oPlanningPDF</span> = <span class='native'>new</span> PlanningHTMLHelper(<span class='texte pointer hover-bold' title=\"Date de début au format [Y-m-d]\">\"2017-01-02\"</span>, <span class='nombre pointer hover-bold' title=\"Nombre de jours à afficher\">5</span>, <span class='nombre pointer hover-bold' title=\"Heure de début de chaque jour de la semaine\">8</span>, <span class='nombre pointer hover-bold' title=\"Heure de fin de chaque jour de la semaine\">19</span>, <span class='nombre pointer hover-bold' title=\"Heure du repas\">13</span>, <span class='nombre pointer hover-bold' title=\"Durée du repas\">1</span>);<br/>
