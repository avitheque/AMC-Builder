<?php
	...
	class Bootstrap {
		...
		public function __construct($sEnv = 'default') {
			...
			$aGit			=						DataHelper::get($aConfig,	'git');
			 ...
			 * GIT
			 */
			defined('GIT_ACTIVE')					||	define('GIT_ACTIVE',						DataHelper::get($aGit,	'active',							DataHelper::DATA_TYPE_BOOL));
			defined('GIT_REPOSITORY')				||	define('GIT_REPOSITORY',					DataHelper::get($aGit,	'repository',						DataHelper::DATA_TYPE_STR));
